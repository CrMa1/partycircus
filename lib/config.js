...
export const PACKAGES = [
  ...
  },
  {
    ...
    includes: [
      'Todo lo que incluye Salón',
      'Taquiza de guisados y menú infantil',
      '20 L de agua de sabor + hielo ilimitado',
  ...
  },
  {
    ...
    includes: [
      'Todo lo que incluye Party',
      'Inflable 3 m × 3 m',
      'Taquiza o parrillada (a elegir)',
      'Refresco ilimitado + 40 L de agua',
      'Show con botarga o personaje (1 hr)',
      '10 regalos para invitados',
      'Mesa de dulces + botana al centro',
